...
public class GameScreen extends ScreenAdapter {
    ...
    public boolean enableCellClick = true;

    public GameScreen(int p, int b, Game g) {
        players = p;
        game = g;
        bots = b;
    }
    ...
    public void show () {
        ...
        inputAdapter = new InputAdapter() {
            ...
            public boolean touchUp(int screenX, int screenY, int pointer, int button) {
                ...
                if (!enableCellClick) return true;
        ...
        rulesController = new GameRulesController(this, players, bots);
    ...
    public void gameEndDialog(final int whichTurn) {
    ...
    public void render (float dt) {
        ...
        sr.dispose();
        uiStage.draw();
        if (buttonMenu.isVisible()) enableCellClick = true;
    }
